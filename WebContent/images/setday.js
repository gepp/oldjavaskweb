...
function wpCalendar(){
	...
	this.versioninfo= "wpCanlendar Version:2.55&#13;作者:WalkingPoison";	//版本信息
	this.tgtObject	= null;
	...
	this.redraw		= function (){				//定义redraw方法，用于重绘整个日历
		...
		with(this.theme){
			...
			strFrame+='table.main{width:' + (this.getCalendarWidth()-2) + 'px;height:' + this.getMainHeight() + 'px;background-color:'+bgColorMain+';}';
