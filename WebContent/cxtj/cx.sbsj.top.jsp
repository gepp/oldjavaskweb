...
//var month = myDate.getMonth()+1-1;//获取的是上月的第一天
///if (month<10){
//    month = "0"+month;
//}
...
//document.getElementsByTagName('startdate').value=firstDay;
//document.getElementsByTagName('enddate').value=lastDay;
function  trim(str){
...
function add(){
	...
	//else{
		...
		parent.document.getElementById('sbsjList').src = '/javaskweb/cxtj.do?op=toSbsjList&nsrwjbm='+nsrwjbm+'&startdate='+startdate+'&enddate='+enddate+'&swjgbm='+swjgbm;
	//}
}
</script>
</head>
  ...
  <div id="main">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="userList">
      <tr>
        ...
        <td width="25%"><input type="text" name="nsrwjbm" id="nsrwjbm" maxlength="16" style="width: 270px;"><div id="auto"></div></td>
        <td width="12%">税务机关：</td>
      ...
      <tr>
        <td>所属期：</td>
        <td colspan="3">开始时间：<input type="text" id="startdate" value=<%=startdate %> name="startdate" style="width:15%" onClick="WdatePicker({isShowWeek:true})" readonly>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
