...
function add(){
	if(confirm('确定税控卡已插入！')){
		sAlert('解锁中，请等待……');
		try{
			var result = document.UnBlockLet.unBlock();
  ...
  <div id="tool">
    ...
    <div id="main"> <br />
      ...
      <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0" id="userLogin1" >
        <tr>
          <th width="5%">税控卡使用口令解锁 </th>
        </tr>
        <tr>
          <td height="152" style="text-align:center">
          
          <br>
          <input type="button" name="btn" value=" 税控卡使用口令解锁 " style="cursor:hand;" onclick="add();" />
          <jsp:plugin name="UnBlockLet" type="applet" archive="dtapplet.jar" codebase=".." code="com.jsdt.web.applet.TYFCUnBlockLet.class" height="1" width="1" >
<jsp:params>  
