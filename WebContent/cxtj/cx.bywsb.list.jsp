  ...
  <div id="main">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="userList2">
      <tr>
        ...
        <th width="22%">明细申报状态</th>
        <th width="8%">日交易申报状态</th>
      </tr>
<%
...
%>
	  <tr>
        ...
        <td align="center"><%=wsbsj.isWsbmx()?"已申报":"<font color=red>未申报</font>" %>&nbsp;</td>
        <td align="center"><%=wsbsj.isWsbrjy()?"已申报":"<font color=red>未申报</font>" %>&nbsp;</td>
      </tr>
<%
	}
}
