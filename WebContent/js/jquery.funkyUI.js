...
function install(el, opts) {
    ...
    var arr = [];
		...
		if(opts.showDialog){
			...
			arr.push("    <td width='13' height='33' style=\"background-image:url(images/dialog_lt.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='images/dialog_lt.png', sizingMethod='crop');\"><div style='width:13px;'></div></td>");
			arr.push("    <td height='33' style=\"background-image:url(images/dialog_ct.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='images/dialog_ct.png', sizingMethod='crop');\"><div style=\"float:left;font-weight:bold; color:#FFFFFF; padding:9px 0 0 4px;\"><img src=\"images/icon_dialog.gif\" align=\"absmiddle\">&nbsp;"+opts.title+"</div>");
			arr.push("      <div style=\"position: relative;cursor:pointer; float:right; margin:5px 0 0; _margin:4px 0 0;height:17px; width:28px; background-image:url(images/dialog_closebtn.gif)\" onMouseOver=\"this.style.backgroundImage='url(images/dialog_closebtn_over.gif)'\" onMouseOut=\"this.style.backgroundImage='url(images/dialog_closebtn.gif)'\" drag='false' onClick=\"$('#_ButtonCancel_"+opts.id+"').click();\"></div></td>");
			arr.push("    <td width='13' height='33' style=\"background-image:url(images/dialog_rt.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='images/dialog_rt.png', sizingMethod='crop');\"><div style=\"width:13px;\"></div></td>");
			arr.push("  </tr>");
			arr.push("  <tr drag='false'><td width='13' style=\"background-image:url(images/dialog_mlm.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='images/dialog_mlm.png', sizingMethod='crop');\"></td>");
			...
			arr.push("          <td height='50' valign='top'><table id='_MessageTable_"+opts.id+"' width='100%' border='0' cellspacing='0' cellpadding='8' style=\" background:#EAECE9 url(images/dialog_bg.jpg) no-repeat right top;\">");
			arr.push("              <tr><td width='25' height='50' align='right'><img id='_MessageIcon_"+opts.id+"' src='images/window.gif' width='32' height='32'></td>");
			...
			arr.push("            </div></td></tr>");
			arr.push("      </table></td>");
			arr.push("    <td width='13' style=\"background-image:url(images/dialog_mrm.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='images/dialog_mrm.png', sizingMethod='crop');\"></td></tr>");
			arr.push("  <tr><td width='13' height='13' style=\"background-image:url(images/dialog_lb.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='images/dialog_lb.png', sizingMethod='crop');\"></td>");
			arr.push("    <td style=\"background-image:url(images/dialog_cb.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='images/dialog_cb.png', sizingMethod='crop');\"></td>");
			arr.push("    <td width='13' height='13' style=\"background-image:url(images/dialog_rb.png) !important;background-image: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='images/dialog_rb.png', sizingMethod='crop');\"></td>");
			arr.push("  </tr></table>");
		}else{
			arr.push("<table width=\"200\" height=\"59\" style=\"border:solid #5e97cc 1px; background-color:#FFFFFF \">");
			arr.push("  <tr>");
			arr.push("    <td width=\"74\" height=\"53\" align=\"center\" valign=\"middle\"><img src=\"images/loading1.gif\" width=\"32\" height=\"32\" /></td>");
...
//	$.DialogData.dialogDiv.find("input[id^='_ButtonCancel_']").attr('value','确 定');
	...
	arr.push("<tr><td align='center'><img id='Icon' src='images/icon_alert.gif' width='34' height='34' align='absmiddle'></td>");
