...
<div id="right">
  <div id="tool">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableListTitle" style="padding-top:14px;">
      <tr>
      	<td>&nbsp;&nbsp;系统管理 &gt;&gt;&nbsp;&nbsp;<a href="/javaskweb/system.do?op=toZclxList" class="nav">注册类型管理</a>&gt;&gt;&nbsp;&nbsp;新增</td>
      </tr>
    </table>
  </div>
  <div id="main">
    <form name="form1" action="/javaskweb/system.do?op=zclxAddAction" method="post" onSubmit="return validator(this)">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableForm">
        <tr>
          <td width="15%">注册类型编码：</td>
          <td><input type="text" style="width:30%" name="zclxbm" required="required" controlName="注册类型编码" /></td>
        </tr>
        <tr>
          <td>注册类型名称：</td>
          <td><input type="text" style="width:30%" name="zclxmc" required="required" controlName="注册类型名称" /></td>
        </tr>
        <tr>
          <td>注册类型简称：</td>
          <td><input type="text" style="width:30%" name="zclxjc" /></td>
        </tr>
        <tr>
          <td>注册类型状态：</td>
          <td>
