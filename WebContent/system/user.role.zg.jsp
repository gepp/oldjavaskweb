...
function add(){
	if(confirm('确认分配角色？')){
		...
		document.getElementById('iframe').src = '/javaskweb/userServlet?method=roleaddzg&roleidStr='+roleidStr+'&username='+username+'&swjgbm='+swjgbm;
	}	
}
...
<div id="right">
  <div id="tool">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableListTitle" style="padding-top:14px;">
      <tr>
      	<td style="font-size:16px; font-weight:800;">&nbsp;&nbsp;系统管理 &gt;&gt;&nbsp;&nbsp;<a href="/javaskweb/userServlet?method=userlist&swjgbm=<%=swjgbm %>" class="nav">用户管理</a>&gt;&gt;&nbsp;&nbsp;角色分配</td>
        <td align="right">
        <input type="hidden" id="username" name="username" value="<%=username %>"/>
        <input type="hidden" id="swjgbm" name="swjgbm" value="<%=swjgbm %>"/>
        <input type="button" name="btn" value=" 确 定 " onclick="add();" style="cursor:hand;" />&nbsp;&nbsp;
        <input type="button" name="btn" value=" 返 回 " style="cursor:hand;" onclick="window.location.href='/javaskweb/userServlet?method=userlist&swjgbm=<%=swjgbm %>';" />&nbsp;&nbsp;&nbsp;&nbsp;</td>
      </tr>
    </table>
  </div>
  <div id="main">
