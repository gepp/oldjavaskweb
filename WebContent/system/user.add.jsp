...
<div id="right">
  <div id="tool">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableListTitle" style="padding-top:14px;">
      <tr>
      	<td>&nbsp;&nbsp;系统管理 &gt;&gt;&nbsp;&nbsp;<a href="/javaskweb/system.do?op=toUserList" class="nav">用户管理</a>&gt;&gt;&nbsp;&nbsp;新增</td>
      </tr>
    </table>
  </div>
  <div id="main">
    <form name="form1" action="/javaskweb/system.do?op=userAddAction" method="post" onSubmit="return validator(this)">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableForm">
        <tr>
          <td width="15%">登录名：</td>
          <td><input type="text" style="width:30%" name="username" required="required" controlName="登录名" /></td>
        </tr>
        <tr>
          <td>真实姓名：</td>
          <td><input type="text" style="width:30%" name="actualname" required="required" controlName="真实姓名" /></td>
        </tr>
        <tr>
          <td>密码：</td>
          <td><input type="password" style="width:30%" name="password" required="required" controlName="密码" /></td>
        </tr>
        <tr>
          <td>所属税务机关：</td>
          <td>
