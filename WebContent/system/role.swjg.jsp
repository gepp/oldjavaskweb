...
int sid = ((Integer)request.getAttribute("sid")).intValue();
%>
...
function serch_user(swjgbm,sid){
	window.location.href='/javaskweb/roleServlet?method=roleuserlist&swjgbm='+swjgbm+'&sid='+sid;
}
</script>
</head>
<body>
...
%>
      <tr>
        ...
        <td><input type="button" name="btn" value="查看用户" style="cursor:hand;" onclick="serch_user('<%=swjg.getSwjgbm() %>',<%=sid %>);" />&nbsp;</td>
      </tr>
<%
	}
}
