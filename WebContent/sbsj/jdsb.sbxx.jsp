      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableListBottom">
        <tr>
          <td height="50" align="center">
			...
			<!--<applet name="dtapplet" code="com.jsdt.web.applet.TYUcReadlet.class" codebase="." archive="dtapplet.jar" width="1" height="1">-->
			<input type="button" name="btn" value="返  回" onclick="window.location.href='/javaskweb/sbsj.do?op=toJdsb';" />
          </td>
        </tr>
      </table>
