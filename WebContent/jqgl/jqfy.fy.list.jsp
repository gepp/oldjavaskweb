...
function fyxxlr(nsrbm,jqbh){
	 window.location.href='taxpayer.do?op=fyxxlr&nsrbm='+nsrbm+'&jqbh='+jqbh;
...
<div id="right">
  <div id="tool">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableListTitle" style="padding-top:14px;">
      <tr>
      	<td style="font-size:16px; font-weight:800;">&nbsp;&nbsp;机器管理 &gt;&gt;&nbsp;&nbsp;<a href="/javaskweb/taxpayer.do?op=toImport" class="nav">复业</a> &gt;&gt;&nbsp;&nbsp;机器复业</td>
      </tr>
    </table>
  </div>
  <div id="main">
...
%>
	  <tr>
        ...
        <td align="center"><input type="button" name="btn" value="复 业"  onclick="fyxxlr('<%=nsrxx.getNsrwjbm()%>','<%=tfy.getJqbh()%>')"/></td>
      </tr>
<%
	}
}
