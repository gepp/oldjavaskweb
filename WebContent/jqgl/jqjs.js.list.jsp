...
ArrayList zcJqxxList =(ArrayList)request.getAttribute("sdJqxxList");
%>
...
<div id="right">
  <div id="tool">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableListTitle" style="padding-top:14px;">
      <tr>
      	<td style="font-size:16px; font-weight:800;">&nbsp;&nbsp;机器管理 &gt;&gt;&nbsp;&nbsp;<a href="/javaskweb/taxpayer.do?op=toImport" class="nav">解锁</a> &gt;&gt;&nbsp;&nbsp;机器解锁</td>
      </tr>
    </table>
  </div>
  <div id="main">
    ...
    <form name="form2" action="taxpayer.do?op=jsJqxx"  method="post">
