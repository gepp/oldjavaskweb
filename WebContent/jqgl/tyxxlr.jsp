...
<div id="right">
  <div id="tool">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableListTitle" style="padding-top:14px;">
      <tr>
      	<td style="font-size:16px; font-weight:800;">&nbsp;&nbsp;机器管理 &gt;&gt;&nbsp;&nbsp;<a href="/javaskweb/taxpayer.do?op=toImport" class="nav">停业</a> &gt;&gt;&nbsp;&nbsp;停业注销</td>
      </tr>
    </table>
  </div>
  <div id="main">
    ...
    <form name="form1" action="taxpayer.do?op=updateTyxx" method="post" >
     <input type="hidden" value="<%= nsrxx.getNsrwjbm()%>" name="nsrbm" id="nsrbm"/>
      <input type="hidden" value="<%=jqbh %>" name="jqbh" id="jqbh"/>
        ...
        <tr>
            <td width="10%" height="30" bgcolor="#f2f2f2" class="left_txt2">停业原因：</td>
            <td bgcolor="#f2f2f2"><textarea name="tyyy" id="tyyy" value="" style=" width:460px;height:100px" ></textarea></td>
