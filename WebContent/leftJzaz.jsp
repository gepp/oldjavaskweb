...
//-->
  ...
  <div id="scroll">
    <ul id="menu">
      <li><a href="#">建安项目信息管理</a></li>
    </ul>
    <ul id="menuTwo">
      <li><a href="/javaskweb/jzazServlet?method=import" target="mainFrame">项目管理 </a></li>
      <li><a href="jzaz/xmbg.html" target="mainFrame">项目信息变更 </a></li>
      <li><a href="jzaz/kpbl.html" target="mainFrame">开票信息补录 </a></li>
    </ul>
  </div>
</div>
