 ...
 <script language="javascript" type="text/javascript">
	...
	function add() {
		...
		if (nsrwjbm == '') {
			...
			window.location.href = '/javaskweb/fpService.do?op=infoWLKP&nsrwjbm='+ nsrwjbm;
		}
	};
</script>
</head>
	...
	<div id="right">
		<div id="tool">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableListTitle" style="padding-top: 14px;">
				<tr>
					<td style="font-size: 16px; font-weight: 800;">&nbsp;&nbsp;发票购买&gt;&gt;&nbsp;&nbsp;<a href="#" class="nav">发票领购</a></td>
				</tr>
			</table>
		</div>
		<div id="main">
			...
			<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" id="userLogin">
				<tr>
					<th width="5%">纳税户信息(<font color="red">网票机领票</font>)</th>
				</tr>
				<tr>
					<td height="152"><br /> <strong>请输入纳税户微机编码：</strong> 
					<input name="nsrwjbm" id="nsrwjbm" type="text" maxlength="16"
